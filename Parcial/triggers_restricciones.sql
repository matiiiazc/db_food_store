...
-- TP2 - Parte 1: Integridad versionada
-- ============================================================
-- Reglas de negocio que hoy dependen de la aplicacion y no
-- estan garantizadas por el motor. Se agregan como triggers.
-- ============================================================

-- ============================================================
-- REGLA 1: Baja logica - impedir DELETE directo
-- Solo se permite desactivar con UPDATE ... SET activo = FALSE,
-- nunca borrar fisicamente un registro de categoria o producto.
-- ============================================================
...
-- ============================================================
-- REGLA 3: Subtotal consistente - cantidad x precio_unitario
-- ============================================================
